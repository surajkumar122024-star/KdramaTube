...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl sm:text-4xl font-bold text-[var(--color-text)] mb-2">Privacy Policy</h1>
      <p className="text-sm text-[var(--color-muted)] mb-8">Last updated: August 2026</p>
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">1. Information We Collect</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">2. Cookies</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">3. Third-Party Advertising (Google AdSense)</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">4. Third-Party Links</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">5. Data Security</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">6. Children's Privacy</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
        Our Site is not directed at children under 13, and we do not
        knowingly collect personal information from children.
      </p>

      <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-3">7. Changes to This Policy</h2>
      <p className="text-[var(--color-text)] mb-4 leading-relaxed">
